class ResultPrinter
  def initialize
    # Переменная @results будет содержать массив результатов теста
    @results = [
      # 30-32 очка
  ...
  # Метод, выводящий на экран результаты теста в качестве параметра в метод
  # должен передаваться объект класса Test, у которого метод спросит результат
  # прохождения теста (количество очков).
